// more-menu.js - COMPLETE VERSION with All Features
...
class MoreMenuManager {
            ...
            document.querySelectorAll('.founder-social').forEach(link => {
                link.addEventListener('click', (e) => {
                    ...
                    const urls = {
                        ...
                        portfolio: 'https://vike-store.netlify.app/'
                    };
    ...
    openPortfolio() {
        window.open('https://your-portfolio.netlify.app', '_blank');
    }
    ...
    showLanguageSelector() {
        ...
        let modalContent = `<div class="modal-content"><div class="modal-header"><div class="modal-title">Select Language</div><button class="close-modal-btn">&times;</button></div><div class="language-list">`;
